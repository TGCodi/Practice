...
class MyInfoPage(BasePage):
    ...
    SAVE_BUTTON_FIRST = ("xpath", "(//button[@type='submit'])[1]")
    ...
    def save_changes(self):
        self.wait.until(EC.element_to_be_clickable(self.SAVE_BUTTON_FIRST)).click()

    @allure.step("Changes has been sucsesfuly")
